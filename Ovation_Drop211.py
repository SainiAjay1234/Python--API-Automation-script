...
url_SPDResponse =  "http://192.168.116.211:9001/v1/points/spd" 
response = requests.get(url_SPDResponse, headers=Headers, verify="ov38.dmz.crt")
signal = response.text
print(type(signal))


os.remove("C:\\Users\\Admin\\AppData\\Local\\Programs\\Python\\Python37\\IntegrationTests\\app\\multiple_points\\Ajay\\MultipleSidUpdate\\MainResult1_Ovation.txt")
        ...
        with open(path+ 'Repopulate'+str(i)+'.json') as file:
                ...
                for line in lines:
                        ...
                        if(IsComp == "true"):break                       
                                ...
                                with open(path+"\\MainResult1_Ovation.txt", "a+") as file:
                                ...
                                #print(json_sid)
                                #print(json_pnt)
                                url_SPDResponse =  "http://192.168.116.211:9001/v1/points/spd" +"?"+ "start=" + str(points_sid)
